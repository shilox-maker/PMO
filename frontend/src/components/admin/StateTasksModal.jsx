...
import { X, Plus, Trash2, CheckCircle2, Flag, AlertCircle } from 'lucide-react';

export default function StateTasksModal({ state, onClose, onStateUpdated, getAuthHeaders }) {
  ...
  return (
    <div className="m3-dialog-backdrop">
      <div className="m3-dialog glass-panel" style={{ maxWidth: '600px', width: '90%', padding: '24px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          <h3 style={{ fontWeight: 600, fontSize: '1.2rem', display: 'flex', alignItems: 'center', gap: 8 }}>
            <span>{state.icono || '⚙️'}</span> Tareas Preconfiguradas: {state.nombre_estado}
          </h3>
        ...
        <p style={{ fontSize: '0.85rem', color: 'var(--md-sys-color-outline)', marginBottom: 20 }}>
          Define la lista de tareas o hitos que se sugerirán añadir automáticamente cuando un proyecto cambie a este estado.
        </p>
