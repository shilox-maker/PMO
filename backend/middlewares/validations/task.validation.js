...
const taskCreateSchema = Joi.object({
  ...
  estado: Joi.string().uppercase().valid('SIN INICIAR', 'EN CURSO', 'COMPLETADA').default('SIN INICIAR'),
...
const taskUpdateSchema = Joi.object({
  ...
  estado: Joi.string().uppercase().valid('SIN INICIAR', 'EN CURSO', 'COMPLETADA').optional(),
