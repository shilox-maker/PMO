...
async function seed() {
  try {
    ...
    await Facturas.bulkCreate([
      ...
      { id_interno_factura: 'FAC-2026-001', id_proyecto: 'PRJ-2026-001', id_proveedor: sopra.id_proveedor, numero_factura: 'FR-2026-8891', concepto: 'Hito 1: Análisis de procesos y diseño conceptual', fecha_factura: '2026-02-15', importe: 45000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-002', id_proyecto: 'PRJ-2026-001', id_proveedor: sopra.id_proveedor, numero_factura: 'FR-2026-9044', concepto: 'Hito 2: Configuración core financiero y compras', fecha_factura: '2026-04-30', importe: 60000.00, estado: 'PAGADA' },
      ...
      { id_interno_factura: 'FAC-2026-004', id_proyecto: 'PRJ-2026-002', id_proveedor: indra.id_proveedor, numero_factura: 'MNS-2026-1101', concepto: 'Fase 1: Diseño UX/UI y arquitectura del portal', fecha_factura: '2026-03-01', importe: 28000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-005', id_proyecto: 'PRJ-2026-002', id_proveedor: indra.id_proveedor, numero_factura: 'MNS-2026-1250', concepto: 'Fase 2: Desarrollo backend y APIs de integración', fecha_factura: '2026-05-01', importe: 42000.00, estado: 'PAGADA' },
      ...
      { id_interno_factura: 'FAC-2026-007', id_proyecto: 'PRJ-2026-003', id_proveedor: accenture.id_proveedor, numero_factura: 'FAC-ACN-3011', concepto: 'Adquisición y licenciamiento software logístico', fecha_factura: '2026-03-10', importe: 110000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-008', id_proyecto: 'PRJ-2026-003', id_proveedor: accenture.id_proveedor, numero_factura: 'FAC-ACN-3080', concepto: 'Hardware RFID: 200 lectores y antenas', fecha_factura: '2026-04-20', importe: 85000.00, estado: 'PAGADA' },
      ...
      { id_interno_factura: 'FAC-2026-010', id_proyecto: 'PRJ-2026-004', id_proveedor: capgemini.id_proveedor, numero_factura: 'FAC-CAP-998', concepto: 'Auditoría inicial de intrusión física y lógica', fecha_factura: '2026-03-25', importe: 35000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-011', id_proyecto: 'PRJ-2026-004', id_proveedor: capgemini.id_proveedor, numero_factura: 'FAC-CAP-1040', concepto: 'Implementación de soluciones SIEM y XDR', fecha_factura: '2026-05-20', importe: 48000.00, estado: 'PAGADA' },
      ...
      { id_interno_factura: 'FAC-2026-013', id_proyecto: 'PRJ-2026-005', id_proveedor: nttData.id_proveedor, numero_factura: 'NTT-2025-0890', concepto: 'Fase 1: Diseño de arquitectura Databricks', fecha_factura: '2025-08-01', importe: 95000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-014', id_proyecto: 'PRJ-2026-005', id_proveedor: nttData.id_proveedor, numero_factura: 'NTT-2026-0120', concepto: 'Fase 2: Desarrollo ETL y cuadros de mando', fecha_factura: '2026-01-15', importe: 130000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-015', id_proyecto: 'PRJ-2026-005', id_proveedor: nttData.id_proveedor, numero_factura: 'NTT-2026-0380', concepto: 'Fase 3: Despliegue y formación usuarios clave', fecha_factura: '2026-04-10', importe: 80000.00, estado: 'PAGADA' },
      // PRJ-2026-007 SAP S/4HANA
      { id_interno_factura: 'FAC-2026-016', id_proyecto: 'PRJ-2026-007', id_proveedor: deloitte.id_proveedor, numero_factura: 'DLT-2026-0441', concepto: 'Hito 1: Blueprint y mapeo de procesos To-Be', fecha_factura: '2026-05-01', importe: 120000.00, estado: 'PAGADA' },
      ...
      // PRJ-2026-008 RRHH
      { id_interno_factura: 'FAC-2026-018', id_proyecto: 'PRJ-2026-008', id_proveedor: sopra.id_proveedor, numero_factura: 'FR-2026-9200', concepto: 'Consultoría de implementación SuccessFactors HCM', fecha_factura: '2026-04-15', importe: 55000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-019', id_proyecto: 'PRJ-2026-008', id_proveedor: sopra.id_proveedor, numero_factura: 'FR-2026-9355', concepto: 'Licencias SuccessFactors (200 usuarios, 1 año)', fecha_factura: '2026-05-01', importe: 38000.00, estado: 'PAGADA' },
      // PRJ-2026-009 App Móvil
      { id_interno_factura: 'FAC-2026-020', id_proyecto: 'PRJ-2026-009', id_proveedor: nttData.id_proveedor, numero_factura: 'NTT-2026-0450', concepto: 'Sprint 1-4: Core de la app y diseño de UX', fecha_factura: '2026-05-15', importe: 42000.00, estado: 'PAGADA' },
      // PRJ-2026-010 CPD
      { id_interno_factura: 'FAC-2026-021', id_proyecto: 'PRJ-2026-010', id_proveedor: capgemini.id_proveedor, numero_factura: 'FAC-CAP-1200', concepto: 'Diseño y proyecto ejecutivo del CPD', fecha_factura: '2026-06-01', importe: 85000.00, estado: 'PAGADA' },
      // PRJ-2026-011 API Marketplace
      { id_interno_factura: 'FAC-2026-022', id_proyecto: 'PRJ-2026-011', id_proveedor: sopra.id_proveedor, numero_factura: 'FR-2026-8990', concepto: 'Desarrollo del API Gateway y conectores base', fecha_factura: '2026-03-15', importe: 32000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-023', id_proyecto: 'PRJ-2026-011', id_proveedor: sopra.id_proveedor, numero_factura: 'FR-2026-9100', concepto: 'Integración Amazon SP-API y pruebas E2E', fecha_factura: '2026-05-20', importe: 28000.00, estado: 'PAGADA' },
      // PRJ-2026-014 DORA/NIS2
      { id_interno_factura: 'FAC-2026-024', id_proyecto: 'PRJ-2026-014', id_proveedor: deloitte.id_proveedor, numero_factura: 'DLT-2026-0380', concepto: 'Análisis de brecha y hoja de ruta DORA/NIS2', fecha_factura: '2026-05-01', importe: 45000.00, estado: 'PAGADA' },
      // PRJ-2026-015 BI Corporativo
      { id_interno_factura: 'FAC-2026-025', id_proyecto: 'PRJ-2026-015', id_proveedor: indra.id_proveedor, numero_factura: 'MNS-2025-0900', concepto: 'Diseño del Data Warehouse y modelo dimensional', fecha_factura: '2025-10-01', importe: 65000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-026', id_proyecto: 'PRJ-2026-015', id_proveedor: indra.id_proveedor, numero_factura: 'MNS-2026-0110', concepto: 'Desarrollo ETLs y dashboards ejecutivos Power BI', fecha_factura: '2026-02-01', importe: 90000.00, estado: 'PAGADA' },
      { id_interno_factura: 'FAC-2026-027', id_proyecto: 'PRJ-2026-015', id_proveedor: indra.id_proveedor, numero_factura: 'MNS-2026-0330', concepto: 'Licencias Power BI Premium P1 (12 meses)', fecha_factura: '2026-04-01', importe: 48000.00, estado: 'PAGADA' }
    ]);
