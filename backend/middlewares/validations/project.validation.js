...
const projectCreateSchema = Joi.object({
  ...
  id_sede_distribuir: Joi.number().integer().empty('').allow(null).optional(),
  id_sponsor: Joi.number().integer().empty('').allow(null).optional(),
  id_ambito: Joi.number().integer().empty('').allow(null).optional(),
  id_workflow: Joi.number().integer().empty('').allow(null).optional(),
  id_estado: Joi.number().integer().empty('').allow(null).optional(),
  portfolio_id: Joi.number().integer().empty('').allow(null).optional(),
  indicador_rag: Joi.string().valid('VERDE', 'AMARILLO', 'ROJO').default('VERDE'),
  avance_porcentaje: Joi.number().integer().min(0).max(100).default(0),
  fecha_inicio: Joi.string().isoDate().required(),
  fecha_fin_inicial: Joi.string().empty('').isoDate().allow(null).optional(),
  es_capex: Joi.boolean().default(false),
  codigo_capex: Joi.string().allow('', null).optional(),
...
const projectUpdateSchema = Joi.object({
  ...
  avance_porcentaje: Joi.number().integer().min(0).max(100).optional(),
